...
A64_JNIEXPORT void *NikkaHookV(void *const symbol, void *const replace,
...
A64_JNIEXPORT void NikkaHook(void *const symbol, void *const replace, void **result) {
    ...
    trampoline = NikkaHookV(symbol, replace, trampoline, A64_MAX_INSTRUCTIONS * 10u);
